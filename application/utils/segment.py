def msh_dict():
    return {
        ...
        "character_set": [],                                # MSH-18: Character Set
        ...
        "message_profile_identifier": [],                   # MSH-21: Message Profile Identifier
...
def pid_dict():
    return {
        ...
        "patient_identifier_list": [],                 # PID-3: Patient Identifier List
        "alternate_patient_id": None,                    # PID-4: Alternate Patient ID - PID
        "patient_name": [],                            # PID-5: Patient Name
        "mothers_maiden_name": [],                     # PID-6: Mother's Maiden Name
        ...
        "race": [],                                    # PID-10: Race
        "patient_address": [],                         # PID-11: Patient Address
        "county_code": None,                             # PID-12: County Code
        "phone_number_home": [],                       # PID-13: Phone Number - Home
        "phone_number_business": [],                   # PID-14: Phone Number - Business
        ...
        "mothers_identifier": [],                      # PID-21: Mother's Identifier
        "ethnic_group": [],                            # PID-22: Ethnic Group
        ...
        "identity_reliability_code": [],               # PID-32: Identity Reliability Code
        ...
        "production_class_code": [],                   # PID-38: Production Class Code
        "tribal_citizenship": [],                      # PID-39: Tribal Citizenship
        "patient_telecommunication_information": []    # PID-40: Patient Telecommunication Information
    }
...
def pv1_dict():
    return {
        ...
        "referring_doctor": [],                       # PV1-8: Referring Doctor
        "consulting_doctor": [],                      # PV1-9: Consulting Doctor
        ...
        "ambulatory_status": [],                      # PV1-15: Ambulatory Status
        "vip_indicator": None,                          # PV1-16: VIP Indicator
        "admitting_doctor": [],                       # PV1-17: Admitting Doctor
        "patient_type": None,                           # PV1-18: Patient Type
        "visit_number": None,                           # PV1-19: Visit Number
        "financial_class": [],                        # PV1-20: Financial Class
        ...
        "contract_code": [],                          # PV1-24: Contract Code
        ...
        "bad_debt_transfer_amount": 0.0,               # PV1-32: Bad Debt Transfer Amount
        "bad_debt_recovery_amount": 0.0,               # PV1-33: Bad Debt Recovery Amount
        ...
        "current_patient_balance": 0.0,                # PV1-46: Current Patient Balance
        "total_charges": 0.0,                          # PV1-47: Total Charges
        "total_adjustments": 0.0,                      # PV1-48: Total Adjustments
        "total_payments": 0.0,                         # PV1-49: Total Payments
...
def orc_dict():
    return {
        ...
        "quantity_timing": [],                            # ORC-7: Quantity/Timing
        "parent": None,                                     # ORC-8: Parent
        "date_time_of_transaction": None,                   # ORC-9: Date/Time of Transaction
        "entered_by": [],                                 # ORC-10: Entered By
        "verified_by": [],                                # ORC-11: Verified By
        "ordering_provider": [],                          # ORC-12: Ordering Provider
        "enterers_location": None,                         # ORC-13: Enterer's Location
        "call_back_phone_number": [],                     # ORC-14: Call Back Phone Number
        ...
        "action_by": [],                                  # ORC-19: Action By
        "advanced_beneficiary_notice_code": None,           # ORC-20: Advanced Beneficiary Notice Code
        "ordering_facility_name": [],                     # ORC-21: Ordering Facility Name
        "ordering_facility_address": [],                  # ORC-22: Ordering Facility Address
        "ordering_facility_phone_number": [],             # ORC-23: Ordering Facility Phone Number
        "ordering_provider_address": [],                  # ORC-24: Ordering Provider Address
        ...
        "alternate_placer_order_number": [],              # ORC-33: Alternate Placer Order Number
        "order_workflow_profile": []                      # ORC-34: Order Workflow Profile
    }
...
def obr_dict():
    return {
        ...
        "collector_identifier": [],                      # OBR-10: Collector Identifier
        "specimen_action_code": None,                      # OBR-11: Specimen Action Code
        "danger_code": None,                               # OBR-12: Danger Code
        "relevant_clinical_information": [],             # OBR-13: Relevant Clinical Information
        ...
        "order_callback_phone_number": [],               # OBR-17: Order Callback Phone Number
        ...
        "quantity_timing": [],                           # OBR-27: Quantity/Timing
        "result_copies_to": [],                          # OBR-28: Result Copies To
        "parent": None,                                    # OBR-29: Parent
        "transportation_mode": None,                       # OBR-30: Transportation Mode
        "reason_for_study": [],                          # OBR-31: Reason For Study
        "principal_result_interpreter": None,              # OBR-32: Principal Result Interpreter
        "assistant_result_interpreter": [],              # OBR-33: Assistant Result Interpreter
        "technician": [],                                # OBR-34: Technician
        "transcriptionist": [],                          # OBR-35: Transcriptionist
        "scheduled_date_time": None,                       # OBR-36: Scheduled Date/Time
        "number_of_sample_containers": None,               # OBR-37: Number Of Sample Containers
        "transport_logistics_of_collected_sample": [],   # OBR-38: Transport Logistics Of Collected Sample
        "collector_comment": [],                         # OBR-39: Collector's Comment
        ...
        "planned_patient_transport_comment": [],         # OBR-43: Planned Patient Transport Comment
        "procedure_code": None,                            # OBR-44: Procedure Code
        "procedure_code_modifier": [],                   # OBR-45: Procedure Code Modifier
        "placer_supplemental_service_information": [],   # OBR-46: Placer Supplemental Service Information
        "filler_supplemental_service_information": [],   # OBR-47: Filler Supplemental Service Information
        ...
        "alternate_placer_order_number": [],             # OBR-53: Alternate Placer Order Number
...
def obx_dict():
    return {
        ...
        "observation_value": [],                         # OBX-5: Observation Value
        "units": None,                                     # OBX-6: Units
        "reference_range": None,                           # OBX-7: References Range
        "interpretation_codes": [],                      # OBX-8: Interpretation Codes
        "probability": 0.0,                               # OBX-9: Probability
        "nature_of_abnormal_test": [],                   # OBX-10: Nature Of Abnormal Test
        ...
        "responsible_observer": [],                      # OBX-16: Responsible Observer
        "observation_method": [],                        # OBX-17: Observation Method
        "equipment_instance_identifier": [],             # OBX-18: Equipment Instance Identifier
        "date_time_of_the_analysis": None,                 # OBX-19: Date/Time Of The Analysis
        "observation_site": [],                          # OBX-20: Observation Site
...
def populateSegment(current_obj, segment, segment_str, message_type=''):
    ...
    for index, key in enumerate(obj.keys()): # iterate on all keys 
        try:
            ...
            if curr_segment == "msh_9":
                val = message_type

            if val == '' and len(val) <= 0:
                val = None
            else:   
                field = parse_field(val, name=curr_segment)
                
                # default field data type is string
                if field.datatype in numeric_set:
                    if isinstance(obj[key], float):
                        val = float(val)
                    else: 
                        val = int(val)
                elif field.datatype in datetime_set:
                    #convert with timezone
                    try:
                        datetime_obj = datetime.strptime(val, '%Y%m%d%H%M%S.%f%z')
                        val = datetime_obj.strftime('%Y-%m-%d %H:%M:%S%z')
                    except Exception:
                        try:
                ...
                # convert to array, if the value is string (required for array column)
                if isinstance(obj[key], list) and isinstance(val, str):
                    val = [val]
